...
/*
  If one replaces line 29 with factors.push(number / divisor), the function will
  return all of the factors of number in descending order whereas the original function
  returns all of the factors of number in ascending order.

  number % divisor === 0 determines whether the result of the division is an integer.
  If the number has no remainder, the result is an integer, so the number divided by
